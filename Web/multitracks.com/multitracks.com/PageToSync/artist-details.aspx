<%@ Page Language="C#" AutoEventWireup="true" CodeFile="artist-details.aspx.cs" Inherits="artist_details" %>
...
<head>
    ...
    <script type="text/javascript" defer>
        function ShowSection(tab) {
            ...
            if (tab == 'songs') {
                $("#SongsNavItem").addClass("is-active");
                $("#SongsSection").show();

            }
            else if (tab == 'albums') {
                $("#AlbumsNavItem").addClass("is-active");
                $("#AlbumsSection").show();
            }
            else {
                $("#OverviewNavItem").addClass("is-active");
                $(".section").show();
            }
        }
    </script>
    ...
    <form>
        ...
        <asp:Panel ID="ErrorPanel" runat="server">
            ...
            <div class="u-container">
                <a href="../index.aspx">Back To Artist List</a>
            </div>
        </asp:Panel>
            ...
            <div class="wrapper mod-standard mod-gray">
                <div class="details-banner">
                    ...
                    <div class="details-banner--hero">
                        <asp:Image ID="HeroImage" runat="server" CssClass="details-banner--hero--img" />
                    ...
                    <div class="details-banner--info">
                        <a href="#" class="details-banner--info--box">
                            <asp:Image ID="ArtistImage" runat="server" CssClass="details-banner--info--box--img" />
                        </a>
                        <h1 class="details-banner--info--name">
                            <asp:HyperLink ID="ArtistNameLink" CssClass="details-banner--info--name--link" runat="server" NavigateUrl="#"></asp:HyperLink>
                        </h1>
                    </div>
                </div>
                ...
                <nav class="discovery--nav">
                    <ul class="discovery--nav--list tab-filter--list u-no-scrollbar">
                        <li id="OverviewNavItem" class="discovery--nav--list--item tab-filter--item is-active">
                            <a class="tab-filter" onclick="ShowSection('overview');">Overview</a>
                        </li>
                        <li id="SongsNavItem" class="discovery--nav--list--item tab-filter--item">
                            <a class="tab-filter" onclick="ShowSection('songs');">Songs</a>
                        </li>
                        <li id="AlbumsNavItem" class="discovery--nav--list--item tab-filter--item">
                            <a class="tab-filter" onclick="ShowSection('albums');">Albums</a>
                        </li>
                        <li id="ArtistsNavItem" class="discovery--nav--list--item tab-filter--item">
                            <a class="tab-filter" href="../index.aspx">Back To Artists</a>
                        </li>
                    </ul>
                ...
                <div class="u-container">
                    <main class="discovery--section">
                        ...
                        <section id="SongsSection" class="standard--holder section">
                        ...
                        <div id="AlbumsSection" class="discovery--space-saver section">
                                        ...
                                        <asp:Repeater ID="AlbumsRepeater" runat="server">
                                            <ItemTemplate>
                                                <div class="media-item">
                                                    <a class="media-item--img--link" href="#">
                                                        <img class="media-item--img" alt='<%# Eval("albumTitle") %>' src='<%# Eval("imageUrl") %>' />
                                                        <span class="image-tag"><%# Eval("year") %></span>
                                                    </a>
                                                    <a class="media-item--title"><%# Eval("albumTitle") %></a>
                                                    <a class="media-item--subtitle"><%# Eval("artistName") %></a>
                                                </div>
                                            </ItemTemplate>
                                        </asp:Repeater>
                                        <!-- /.media-item -->
                        ...
                        <section class="standard--holder section">
                            <div class="discovery--section--header">
                                <h2>Biography</h2>
                            </div>
                            <!-- /.discovery-section-header -->
                            <div class="artist-details--biography biography">
                                <asp:Literal ID="BiographyLiteral" runat="server"></asp:Literal>
                                <a href="#">Read More...</a>
                            </div>
                        </section>
                        <!-- /.biography-section -->
